...
use App\Http\Controllers\Admin\LayananPrivasiController as AdminLayananPrivasiController;
...
Route::prefix('admin')->group(static function () {
    ...
    Route::resource('brevetab', BrevetABController::class);
        ...
        Route::resource('layanan-privasi', AdminLayananPrivasiController::class);
