    ...
    <div class="container py-5">
        ...
        <div class="row align-items-center mb-8 mt-5">
            <div class="col-lg-6 text-center text-lg-start mb-4 mb-lg-0">
                ...
                <p class="lead text-muted mt-3">
                    BimbelKu menghadirkan pembelajaran online interaktif dengan mentor profesional dan materi yang selalu
                    up-to-date.
                </p>
            ...
            <div class="col-lg-6 text-center">
                <img src="https://img.freepik.com/free-vector/financial-accounting-concept-illustration_114360-8115.jpg"
                    class="img-fluid rounded-3 shadow-sm" style="max-height:360px" alt="Belajar Pajak & Akuntansi Online">
            </div>
        </div>
        ...
        <section id="pilihan-kelas" class="mb-5">
            <div class="text-center mb-5">
                ...
                <p class="lead text-muted">Kami menyediakan tiga pilihan kelas dengan kurikulum yang disesuaikan dengan
                    kebutuhan Anda</p>
            </div>
                        ...
                        <div class="card-footer bg-transparent p-4">
                            ...
                            @foreach ($bimbels as $bimbel)
                                <div class="col-lg-5 col-md-6 mb-4">
                                    <div
                                        class="class-card card border-0 shadow-lg h-100 position-relative overflow-hidden">
                                        <div
                                            class="card-header bg-gradient-primary text-white text-center py-4 position-relative">
                                            <div class="class-icon mb-3">
                                                <i class="fa fa-star fa-3x opacity-75"></i>
                                            </div>
                                        ...
                                        <div class="card-body p-4">
                                            <div class="price-section text-center mb-4">
                                                <span class="h2 fw-bold text-primary">Rp
                                                    {{ number_format($bimbel->harga, 0, ',', '.') }}</span>
                                ...
                                @endforeach
                                        ...
                                        <div class="card-footer bg-transparent p-4">
                                            ...
                                            @else
                                                <a href="{{ route('login') }}"
                                                    class="btn btn-outline-primary btn-lg w-100 rounded-pill fw-semibold shadow-sm">
                                                    <i class="fa fa-sign-in-alt me-2"></i> Login untuk pilih
                                                    {{ $bimbel->judul }}
                                                </a>
                                            @endauth
                ...
                <table class="table table-borderless comparison-table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center"><i class="fa fa-check text-success fa-lg"></i>
                            </td>
                            <td class="text-center"><i class="fa fa-check text-success fa-lg"></i>
                            </td>
                            <td class="text-center"><i class="fa fa-check text-success fa-lg"></i>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 shadow-sm border-0 course-card">
                        <img src="https://img.freepik.com/free-vector/online-tax-consultation-concept-illustration_114360-6789.jpg"
                            class="card-img-top rounded-top-3" style="height:220px; object-fit:cover"
                            alt="{{ $course->title }}" />
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto d-flex justify-content-between align-items-center">
                                ...
                                <a href="{{ route('bimbel.courses.show', $course->id) }}"
        ...
        <div class="row align-items-center mt-5">
            ...
            <div class="col-md-6">
                ...
                <ul class="list-unstyled fs-5">
                    <li class="mb-2"><i class="fa fa-check-circle text-success me-2"></i>Materi Pajak & Akuntansi
                        Lengkap</li>
                    ...
                    <li class="mb-2"><i class="fa fa-check-circle text-success me-2"></i>Latihan Soal & Ujian Online
                    </li>
