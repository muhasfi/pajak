    ...
    <div class="container">
        ...
        <nav class="breadcrumb-nav">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('in.house') }}">Pelatihan</a></li>
                <li class="breadcrumb-item active">{{ Str::limit($training->judul, 25) }}</li>
            </ol>
        </nav>

        <!-- Page Title -->
        <h1 class="page-title animate-fade-in text-wrap-balance">{{ $training->judul }}</h1>

        <div class="training-main-card animate-fade-in">
            <div class="row g-0">
                <!-- Image and Action Sidebar -->
                <div class="col-12 col-lg-4">
                    <div class="image-container">
                        @if($training->gambar)
                            <img src="{{ Str::startsWith($training->gambar, ['http://','https://']) ? $training->gambar : asset('storage/' . $training->gambar) }}"
                                 class="training-image img-responsive"
                                 alt="{{ $training->judul }}"
                    ...
                    <div class="action-sidebar">
                        ...
                        <a href="https://wa.me/6281234567890?text=Halo,%20saya%20tertarik%20dengan%20pelatihan%20{{ urlencode($training->judul) }}" 
                        ...
                        <div class="action-note">
                            ...
                            Dapatkan penawaran khusus dengan request proposal sekarang!
                        </div>
                    </div>
                </div>
                    ...
                    <div class="info-content">
                            ...
                            <div class="info-grid">
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-text">
                                        ...
                                        <div class="info-value">
                                            {{ $training->detail->durasi_jam ?? '-' }} jam
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-text">
                                        ...
                                        <div class="info-value">{{ $training->detail->kuota_peserta ?? '-' }} peserta</div>
                                    </div>
                                </div>
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-text">
                                        ...
                                        <div class="info-value">{{ $training->detail->tempat ?? '-' }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-text">
                                        ...
                                        <div class="info-value">{{ $training->detail->instruktur ?? '-' }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="info-section">
                            ...
                            <div class="content-text">
                                {!! nl2br(e($training->deskripsi)) !!}
                            </div>
                        </div>
                        @endif

                        <!-- Materi Pelatihan -->
                        @if($training->detail && $training->detail->materi)
                        <div class="detail-card">
                            <div class="card-body">
                                ...
                                @if($training->detail->syarat_peserta)
                                    <div class="content-block">
                                        ...
                                        <div class="content-text">
                                            {!! nl2br(e($training->detail->syarat_peserta)) !!}
                                        </div>
                                    </div>
                                @endif

                                @if($training->detail->fasilitas)
                                    <div class="content-block">
                                        <div class="content-label">
                                        ...
                                        <div class="content-text">
                                            {!! nl2br(e($training->detail->fasilitas)) !!}
                                        </div>
                                    </div>
                                @endif
                            </div>
