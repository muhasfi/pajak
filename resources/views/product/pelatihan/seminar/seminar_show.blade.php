...
<style>
    ...
    .image-container:hover .seminar-image {
...
@section('content')
<section class="seminar-detail-section">
    <div class="container">
        <!-- Breadcrumb Navigation -->
        <nav class="breadcrumb-nav">
            <ol class="breadcrumb">
                {{-- <li class="breadcrumb-item"><a href="{{ route('home') }}">Beranda</a></li> --}}
                <li class="breadcrumb-item"><a href="{{ route('seminar') }}">Seminar</a></li>
                <li class="breadcrumb-item active">{{ Str::limit($seminar->judul, 25) }}</li>
            </ol>
        </nav>

        <!-- Page Title -->
        <h1 class="page-title animate-fade-in text-wrap-balance">{{ $seminar->judul }}</h1>

        <div class="seminar-main-card animate-fade-in">
            <div class="row g-0">
                <!-- Image and Action Sidebar -->
                <div class="col-12 col-lg-4">
                    <div class="image-container">
                        @if($seminar->gambar)
                            <img src="{{ Str::startsWith($seminar->gambar, ['http://','https://']) ? $seminar->gambar : asset('storage/' . $seminar->gambar) }}"
                                 class="seminar-image img-responsive"
                                 alt="{{ $seminar->judul }}"
                        ...
                        @else
                            <img src="{{ asset('assets/customer/images/placeholder.png') }}" 
                                 ...
                                 alt="No image">
                        @endif
                        <div class="seminar-badge {{ $seminar->harga == 0 ? 'free' : 'premium' }}">
                    ...
                    <div class="action-sidebar">
                        <div class="price-section">
                            <div class="price-label">Investasi Seminar</div>
                            <div class="seminar-price {{ $seminar->harga == 0 ? 'free' : '' }}">
                        ...
                        <a href="https://wa.me/6281234567890?text=Halo,%20saya%20tertarik%20dengan%20seminar%20{{ urlencode($seminar->judul) }}" 
                        ...
                        <div class="action-note">
                            ...
                            Dapatkan sertifikat dan materi eksklusif dengan mendaftar sekarang!
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-8">
                    <div class="info-content">
                            ...
                            <div class="info-grid">
                                ...
                                <div class="info-item">
                                    ...
                                    <div class="info-text">
                                        ...
                                        <div class="info-value">{{ $seminar->waktu_pelaksanaan }}</div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="content-block">
                                    ...
                                    <div class="speaker-section">
                                        ...
                                        <div class="speaker-role">Pembicara Seminar</div>
                                        @if($detail->kategori)
                                        <div class="speaker-role mt-1">Spesialis: {{ $detail->kategori }}</div>
                                        @endif
                                        @if($detail->level)
                                        <div class="speaker-role mt-1">Level: {{ $detail->level }}</div>
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="text-center text-lg-start">
                            <a href="{{ route('seminar') }}" class="btn btn-back">
