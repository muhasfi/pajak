            ...
            <div class="courses-grid">
                ...
                <div class="course-card premium" data-category="premium">
                    <div class="course-image">
                        ...
                        <div class="course-badge badge-seminar">SEMINAR</div>
                    ...
                    <div class="course-content">
                        ...
                        <div class="seminar-details">
                            <div class="detail-item">
                                ...
                                <span>15 Des 2024 • 09:00 WIB</span>
                            </div>
                            <div class="detail-item">
                        ...
                        <div class="course-actions">
                            ...
                            <button class="btn btn-premium">Daftar Sekarang</button>
                        </div>
                    </div>
                </div>
                
                <!-- Seminar Card 2 - Gratis -->
                <div class="course-card gratis" data-category="gratis">
                    <div class="course-image">
                        <img src="{{ asset('assets/customer/images/seminar2.jpg') }}" alt="PPN Seminar" />
                        <div class="course-badge badge-webinar">SEMINAR</div>
                    ...
                    <div class="course-content">
                        ...
                        <div class="seminar-details">
                            <div class="detail-item">
                                <i class="fas fa-calendar"></i>
                                <span>20 Des 2024 • 14:00 WIB</span>
                            </div>
                            <div class="detail-item">
                        ...
                        <div class="course-actions">
                            ...
                            <button class="btn btn-free">Daftar Sekarang</button>
                        </div>
                    </div>
                </div>
                
                <!-- Seminar Card 3 - Premium -->
                <div class="course-card premium" data-category="premium">
                    <div class="course-image">
                        <img src="{{ asset('assets/customer/images/seminar3.jpg') }}" alt="Internal Audit Seminar" />
                        <div class="course-badge badge-workshop">WORKSHOP</div>
                    ...
                    <div class="course-content">
                        ...
                        <div class="seminar-details">
                            <div class="detail-item">
                                <i class="fas fa-calendar"></i>
                                <span>25 Des 2024 • 08:30 WIB</span>
                            </div>
                            <div class="detail-item">
                                <i class="fas fa-map-marker-alt"></i>
                                <span>Raffles Hotel, Jakarta</span>
                            </div>
                            <div class="detail-item">
                                <i class="fas fa-clock"></i>
                                <span>8 Jam • Workshop Kit</span>
                            </div>
                        </div>
                ...
                <!-- Seminar Card 4 - Gratis -->
                <div class="course-card gratis" data-category="gratis">
                    <div class="course-image">
                        <img src="{{ asset('assets/customer/images/seminar1.jpg') }}" alt="Tax Amnesty Seminar" />
                        <div class="course-badge badge-seminar">SEMINAR</div>
                        <div class="status-badge status-new">BARU</div>
                    </div>
                    <div class="course-content">
                        <h3 class="course-title">Tax Amnesty Jilid II: Persiapan dan Strategi</h3>
                        
                        <div class="mentor-info">
                            <img src="{{ asset('assets/customer/images/mentor2.jpeg') }}" alt="Mentor" class="mentor-avatar">
                            <div class="mentor-details">
                                <span class="mentor-name">Budi Santoso, S.E., Ak.</span>
                                <span class="mentor-role">Tax Consultant</span>
                            </div>
                        </div>
                        ...
                        <div class="seminar-details">
                            <div class="detail-item">
                                <i class="fas fa-calendar"></i>
                                <span>28 Des 2024 • 13:00 WIB</span>
                            </div>
                            <div class="detail-item">
                                <i class="fas fa-video"></i>
