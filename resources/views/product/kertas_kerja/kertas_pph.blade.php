...
<head>
    ...
    <title>Kertas Kerja PPh 21</title>
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 576px) {
            ...
            .form-preview, .bukti-preview, .rekap-preview, .supporting-preview {
                padding: 1.5rem;
            }
            ...
            .rekap-header span:nth-child(2),
            .rekap-row span:nth-child(2),
            .rekap-total span:nth-child(2) {
                display: none;
            }
        }
        ...
        /* Print Styles */
        @media print {
            .hero-actions, .card-footer, .tab-buttons {
                display: none;
            }
