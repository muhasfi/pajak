        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-header text-center bg-primary text-white py-4 rounded-top-4">
                    <h2 class="mb-2">{{ $audit->detail->paket ?? $audit->judul }}</h2>
                    <h4 class="fw-bold">{{ 'Rp ' . number_format($audit->harga, 0, ',', '.') }}</h4>
                </div>

                <div class="card-body p-4">
                    {{-- Deskripsi --}}
                    <div class="mb-4">
                        <h5 class="fw-semibold mb-2">Deskripsi audit</h5>
                        <p class="text-muted fs-5">
                            {{ $audit->detail->deskripsi ?? 'Deskripsi belum tersedia.' }}
                        </p>
                    </div>
