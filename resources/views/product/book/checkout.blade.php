...
@section('content')
    ...
    <section class="checkout-header">
        <div class="container">
            ...
            <p class="checkout-subtitle animate-fade-in delay-100">Silakan isi detail pemesanan Anda dengan lengkap dan benar
            </p>
        </div>
    </section>
                    ...
                    <div class="col-lg-7">
                        <div class="form-container animate-fade-in">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="note" class="form-control form-textarea"
                                    placeholder="Contoh: Warna tertentu, ukuran khusus, atau instruksi pengiriman"></textarea>
                            </div>
                        </div>
                                ...
                                @foreach (session('cart') as $item)
                                    ...
                                    <div class="order-item">
                                        ...
                                        <div class="order-item-details">
                                            ...
                                            <div class="order-item-price">Rp{{ number_format($item['price'], 0, ',', '.') }}
                                            </div>
                    ...
                    <div class="col-lg-5">
                        <div class="order-summary animate-fade-in delay-200">
                            ...
                            <div class="summary-total">
                                ...
                                <span
                                    class="total-value">Rp{{ number_format($subTotal + $subTotal * 0.1, 0, ',', '.') }}</span>
                            </div>
                ...
                fetch("{{ route('checkout.store') }}", {
                    ...
                    .then(async response => {
                        ...
                        if (data.status === "success") {
                            window.location.href = "{{ url('/checkout/order-pay') }}/" + data
                                .order_code;
                        }
                    })
                    .catch(error => {
                        console.error("Fetch error:", error);
                        alert("Gagal mengirim request: " + error);
                    });
