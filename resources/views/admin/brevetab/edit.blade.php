...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('brevetab.update', $brevetab) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="d-flex justify-content-between mt-4">
                <div>
                    <a href="{{ route('brevetab.show', $brevetab) }}" class="btn btn-info">
                        <i class="bi bi-eye"></i> Lihat Detail
                    </a>
                    <a href="{{ route('brevetab.index') }}" class="btn btn-secondary">
