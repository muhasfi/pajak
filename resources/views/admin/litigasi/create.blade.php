...
<div class="card">
    <div class="card-body">
        ...
        <!-- Form Tambah Layanan -->
        <form class="form" action="{{ route('admin.litigasi.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group d-flex justify-content-end mt-4">
                            ...
                            <a href="{{ route('admin.litigasi.index') }}" class="btn btn-light-secondary me-1 mb-1">
