...
@section('title', 'Daftar Layanan Transfer')
                ...
                <table class="table table-striped" id="table1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.transfer.show', $item->id) }}" class="btn btn-info btn-sm">
                                    <i class="bi bi-eye"></i> Detail
                                </a>
                                <a href="{{ route('admin.transfer.edit', $item->id) }}" class="btn btn-warning btn-sm">
                                    <i class="bi bi-pencil"></i> Ubah
                                </a>
                                <form action="{{ route('admin.transfer.destroy', $item->id) }}" method="POST" class="d-inline delete-form">
                                    @csrf
                                    @method('DELETE')
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted">Belum ada layanan Transfer</td>
                        </tr>
                        @endforelse
                    </tbody>
