        ...
        <div class="col-md-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('webinars.create') }}" class="btn btn-primary">
                    <i class="bi bi-plus-circle"></i> Tambah Webinar Baru
                </a>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $loop->iteration + ($webinars->currentPage() - 1) * $webinars->perPage() }}</td>
                                    <td>
                                        @if($webinar->gambar)
                                    ...
                                    <td>
                                        ...
                                        <small class="text-muted">
                                            {{ Str::limit($webinar->deskripsi, 50) }}
                                        </small>
                                    </td>
                                    <td>
                                        {{ \Carbon\Carbon::parse($webinar->tanggal)->format('d M Y H:i') }}
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="badge bg-info">
                                            {{ $webinar->details->count() }} Pembicara
                                        </span>
                                    </td>
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <form action="{{ route('webinars.destroy', $webinar->id) }}" 
                                                  method="POST" 
                                                  class="d-inline"
                                                  onsubmit="return confirm('Apakah Anda yakin ingin menghapus webinar ini?')">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-4">
                                        <div class="text-muted">
                                            ...
                                            <h5 class="mt-2">Belum ada webinar</h5>
                                            <p>Silakan tambahkan webinar pertama Anda.</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
