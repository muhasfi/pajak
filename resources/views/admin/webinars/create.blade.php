    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('webinars.store') }}" method="POST" enctype="multipart/form-data" id="webinarForm">
                        @csrf
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div id="speakers-container">
                                        <!-- Pembicara akan ditambahkan di sini secara dinamis -->
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <div id="noImage" class="text-muted">
                                                ...
                                                <p class="mt-2 mb-0">Gambar akan ditampilkan di sini</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card mt-3">
                                        ...
                                        <div class="card-body">
                                            <small class="text-muted">
                                                ...
                                                <p>Anda dapat menambahkan multiple pembicara untuk webinar ini.</p>
                                            </small>
                                        </div>
                                    </div>
                                </div>
...
<template id="speaker-template">
    <div class="speaker-item card mb-3">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h6 class="card-title mb-0">Pembicara</h6>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Tambah pembicara pertama secara otomatis
    addSpeaker();
