    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('webinars.update', $webinar->id) }}" method="POST" enctype="multipart/form-data" id="webinarForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    <a href="{{ route('webinars.index') }}" class="btn btn-secondary me-md-2">Batal</a>
