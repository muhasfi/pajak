...
<div class="row">
    <div class="col">
        <h1 class="h3">Tambah Webinar Baru</h1>
    </div>
    <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="time" class="form-control @error('waktu_pelaksanaan') is-invalid @enderror" 
                                   ...
                                   value="{{ old('waktu_pelaksanaan', isset($webinar) ? $webinar->waktu_pelaksanaan : '') }}" required>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="lokasi" class="form-label">Link / Lokasi Webinar <span class="text-danger">*</span></label>
                        <input type="text" class="form-control @error('lokasi') is-invalid @enderror" id="lokasi" name="lokasi" value="{{ old('lokasi') }}" placeholder="contoh: Zoom / Google Meet / Link Online" required>
                        @error('lokasi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="file_path" class="form-label">Link Webinar</label>
                        <input type="text" name="file_path" id="file_path" class="form-control"
                            value="{{ old('file_path', $webinar->detailWebinar->file_path ?? '') }}"
            ...
            <div class="mt-3">
                <button type="submit" class="btn btn-primary w-100">
                    <i class="fas fa-save"></i> Simpan Webinar
                </button>
            </div>
        </div>
    </div>
