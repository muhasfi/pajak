    ...
    <div class="page-title">
        <div class="row">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <a href="{{ route('bimbel.index') }}" class="btn btn-secondary float-start float-lg-end">
...
@endif
                ...
                <form class="form" action="{{ route('bimbel.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
