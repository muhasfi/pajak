            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card card-consultation fade-in">
                        ...
                        <div class="card-body">
                            <span class="duration-badge"><i class="far fa-clock"></i>{{ $item->privasiDetails->first()->waktu_menit }} Menit</span>
                            ...
                            <ul class="feature-list">
                                @if($item->privasiDetails->first() && $item->privasiDetails->first()->benefit)
                                    @foreach($item->privasiDetails->first()->benefit as $benefit)
                                        <li><i class="fas fa-check"></i> {{ $benefit }}</li>
                                    @endforeach
                                @else
                                    <li><i class="fas fa-check"></i> Tidak ada benefit tersedia</li>
                                @endif
