                ...
                <div class="article-actions">
                    ...
                    <div class="share-section">
                        ...
                        <div class="share-buttons">
                            ...
                            <button class="share-button link copy-link" title="Copy Link">
                    ...
                    <div class="popular-list">
                        @for($i = 1; $i <= 5; $i++)
                            <div class="popular-item">
                                <div class="popular-rank">0{{ $i }}</div>
                                <div class="popular-content">
                                    <h4>
                                        <a href="#">Cara Mudah Lapor SPT Tahunan 2024 untuk Pemula</a>
                                    </h4>
                                    <div class="popular-meta">
                                        <span>{{ number_format(rand(1000, 5000)) }} views</span>
                                        <span>•</span>
                                        <span>{{ rand(1, 7) }} hari lalu</span>
                                    </div>
                                </div>
                            </div>
                        @endfor
